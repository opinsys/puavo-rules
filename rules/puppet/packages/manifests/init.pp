class packages {
  ...
  @package {
    ...
    , 'libobasis5.2-core'
    , 'libobasis5.2-draw'
    , 'libobasis5.2-extension-beanshell-script-provider'
    , 'libobasis5.2-extension-javascript-script-provider'
    , 'libobasis5.2-extension-mediawiki-publisher'
    , 'libobasis5.2-extension-nlpsolver'
    , 'libobasis5.2-extension-pdf-import'
    , 'libobasis5.2-extension-report-builder'
    , 'libobasis5.2-gnome-integration'
    , 'libobasis5.2-graphicfilter'
    , 'libobasis5.2-images'
    , 'libobasis5.2-impress'
    , 'libobasis5.2-kde-integration'
    ...
    , 'libobasis5.2-python-script-provider'
    , 'libobasis5.2-pyuno'
    , 'libobasis5.2-writer'
    , 'libobasis5.2-xsltfilter'
    , 'libreoffice5.2'
    , 'libreoffice5.2-base'
    , 'libreoffice5.2-calc'
    , 'libreoffice5.2-debian-menus'
