class packages {
  ...
  @package {
    ...
    , 'libobasis5.3-core'
    , 'libobasis5.3-draw'
    , 'libobasis5.3-extension-beanshell-script-provider'
    , 'libobasis5.3-extension-javascript-script-provider'
    , 'libobasis5.3-extension-mediawiki-publisher'
    , 'libobasis5.3-extension-nlpsolver'
    , 'libobasis5.3-extension-pdf-import'
    , 'libobasis5.3-extension-report-builder'
    , 'libobasis5.3-gnome-integration'
    , 'libobasis5.3-graphicfilter'
    , 'libobasis5.3-images'
    , 'libobasis5.3-impress'
    , 'libobasis5.3-kde-integration'
    , 'libobasis5.3-librelogo'
    , 'libobasis5.3-math'
    , 'libobasis5.3-ogltrans'
    , 'libobasis5.3-onlineupdate'
    , 'libobasis5.3-ooofonts'
    , 'libobasis5.3-ooolinguistic'
    , 'libobasis5.3-postgresql-sdbc'
    , 'libobasis5.3-python-script-provider'
    , 'libobasis5.3-pyuno'
    , 'libobasis5.3-writer'
    , 'libobasis5.3-xsltfilter'
    , 'libreoffice5.3'
    , 'libreoffice5.3-base'
    , 'libreoffice5.3-calc'
    , 'libreoffice5.3-debian-menus'
    , 'libreoffice5.3-dict-es'
    , 'libreoffice5.3-draw'
    , 'libreoffice5.3-impress'
    , 'libreoffice5.3-math'
    , 'libreoffice5.3-ure'
    , 'libreoffice5.3-writer' ]:
      tag => [ 'libreoffice', 'puavo', ];
